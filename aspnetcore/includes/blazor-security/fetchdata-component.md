<span data-ttu-id="83cf0-101">Le `FetchData` composant montre comment :</span><span class="sxs-lookup"><span data-stu-id="83cf0-101">The `FetchData` component shows how to:</span></span>
