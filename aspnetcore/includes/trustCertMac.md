<span data-ttu-id="0377a-101">Visual Studio pour Mac affiche le message suivant :</span><span class="sxs-lookup"><span data-stu-id="0377a-101">Visual Studio for Mac displays the following popup:</span></span>
