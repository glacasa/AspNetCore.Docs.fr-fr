...
Pour les déploiements vers Internet Information Services (IIS) avec la configuration fournie par le fichier *Web. config* , consultez les <xref:host-and-deploy/iis/index>Articles sous.
