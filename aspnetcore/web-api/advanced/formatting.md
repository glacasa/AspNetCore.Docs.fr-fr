...
------------------| |   `/api/products/5`    |    Le formateur de sortie par défaut | | `/api/products/5.json` | Le module de formatage JSON (s’il est configuré) | | `/api/products/5.xml`  | Formateur XML (s’il est configuré) |
