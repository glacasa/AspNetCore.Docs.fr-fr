...
ASP.NET Core 2,1 fournit [ASP.net Core Identity ](xref:security/authentication/identity) sous la forme d’une [ Razor bibliothèque de classes](xref:razor-pages/ui-class) (RCL).
...
Identity2,1 expose des points de terminaison avec la `Identity` zone. Par exemple, le tableau suivant présente des exemples de Identity points de terminaison qui changent de 2,0 à 2,1 :
...
### <a name="update-identity-to-version-21"></a>Mise à jour Identity vers la version 2,1
...
### <a name="replace-identity-20-ui-with-the-identity-21-razor-class-library"></a>Remplacer Identity l’interface utilisateur 2,0 par la Identity Razor bibliothèque de classes 2,1

Cette section décrit les étapes à suivre pour remplacer le code généré par le modèle ASP.net Core 2,0 Identity par la [ Razor bibliothèque de classes](xref:razor-pages/ui-class) [ASP.net Core Identity ](xref:security/authentication/identity) . Les étapes suivantes concernent un Razor projet de pages, mais l’approche d’un projet MVC est similaire.
...
* Supprimer les *zones/ Identity /IdentityHostingStartup.cs*.
...
## <a name="changes-to-razor-pages-projects-razor-files"></a>Modifications apportées aux Razor fichiers de projets de pages Razor
...
## <a name="changes-to-mvc-projects-razor-files"></a>Modifications apportées aux fichiers de projets MVC Razor
