...
Cet article explique comment mettre à jour un projet existant ASP.NET Core 2.2 pour ASP.NET Core 3.0. Il pourrait être utile de créer un nouveau projet ASP.NET Core 3.0 pour :

* Comparez avec le code ASP.NET Core 2.2.
* Copiez les modifications pertinentes à votre projet ASP.NET Core 3.0.
