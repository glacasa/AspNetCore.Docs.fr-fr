...
**Clé**:`webroot`  
**Type**:`string`  
**Défaut**: La `wwwroot`valeur par défaut est . Le chemin vers *la « racine de contenu »/wwwroot* doit exister. Si ce chemin n’existe pas, un fournisseur de fichiers no-op est utilisé.  
