...
## <a name="the-aspnet-core-identity-architecture"></a>Architecture ASP.NET Core Identity
...
## <a name="aspnet-core-identity-stores-data-types"></a>ASP.NET Core Identity stocke les types de données
