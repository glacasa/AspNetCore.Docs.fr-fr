...
Cookie l’authentification, l’état de session et [divers autres composants](https://docs.microsoft.com/aspnet/core/security/samesite?view=aspnetcore-3.0) définissent leurs options sameSite via Cookie des options, par exemple
