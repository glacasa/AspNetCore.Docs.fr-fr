...
* [Hébergé avec AAD](xref:security/blazor/webassembly/hosted-with-azure-active-directory)
...
* [attribut groupMembershipClaims](/azure/active-directory/develop/reference-app-manifest#groupmembershipclaims-attribute)
...
Le [composant AuthorizeView](xref:security/blazor/index#authorizeview-component) fonctionne avec la stratégie :
...
Une vérification de stratégie peut également être [effectuée dans le code avec la logique procédurale](xref:security/blazor/index#procedural-logic):
